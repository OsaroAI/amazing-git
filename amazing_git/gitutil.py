...
class GitRemoteHandler(object):
    ...
    def __init__(self):
        ...
        if 2 == len(self.args):
            ...
            if self.args[1] != self.args[0]:
                self.remote_name = self.args[0]

        self.options = {}
        self._log = logging.getLogger('gitutil.GitRemoteHandler')
    ...
    def handle_command(self, line):
        ...
        if not hasattr(self, 'git_' + command):
